<template>
  <div class="min-h-screen bg-gray-50 flex flex-col" dir="rtl">
    ...
    <header class="bg-white border-b border-emerald-100 px-6 py-4 flex items-center justify-between shadow-sm">
      <div v-if="lawyer" class="flex items-center gap-3">
        <img
        ...
        />
        <div>
          <h3 class="font-bold text-emerald-900 text-sm" style="font-family: 'Amiri', serif;">
    ...
    <!-- STEP 1: Form View -->
    <main v-if="!isSuccess" class="flex-1 flex items-center justify-center p-6">
      <div class="w-full max-w-lg bg-white rounded-2xl border border-emerald-900/10 p-8 shadow-sm">
    ...
    <main v-else class="flex-1 flex items-center justify-center p-6">
      <div class="w-full max-w-md bg-white rounded-2xl border border-emerald-900/10 p-8 shadow-sm text-center">
